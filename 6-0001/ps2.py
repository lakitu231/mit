...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    # Loops until the word is guessed
    while not is_word_guessed(secret_word, letters_guessed):
        print("\n-------------")
        print(f"You have {guesses_remaining} guesses left.")
        print(f"Available letters: {get_available_letters(letters_guessed)}")
        
        # Guesses have to be a letter that has not been already guessed
        ...
        # Game termination if out of guesses
    ...
    # Game termination if the word is guessed
    if win:
        print("------------")
...
def match_with_gaps(my_word, other_word):
    ...
    for i in range(len(other_word)):
        if my_word.replace(' ', '')[i] != '_' and my_word.replace(' ', '')[i] != other_word[i]:
            return False
    return True
