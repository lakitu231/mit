...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for vowels_permutation in permutations:
            ...
            transposed_text = SubMessage.apply_transpose(self, transpose_dict)
            ...
            if max(valid_words) < 1:
                return self.message_text
            
            best_permutation = permutations[valid_words.index(max(valid_words))]
            return SubMessage.apply_transpose(self, best_permutation)
